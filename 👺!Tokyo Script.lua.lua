-- ╔══════════════════════════════════════════════════════════════╗
-- ║   👺 !Tokyo Script V1.0  — RemoteEvent Edition       ║
-- ║   Tutti i Remote sono REALI da ReplicatedStorage            ║
-- ╚══════════════════════════════════════════════════════════════╝
...
if not _ok then warn("[!Tokyo Script V1.0] Errore caricamento: "..tostring(_err)) end
